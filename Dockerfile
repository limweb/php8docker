...
RUN apt install -y php8.1-oci8 php8.1-amqp php8.1-common php8.1-gd php8.1-ldap php8.1-odbc php8.1-readline  php8.1-sqlite3 php8.1-xsl php8.1-apcu php8.1-curl   php8.1-gmp    php8.1-opcache  php8.1-redis  php8.1-mbstring  php8.1-pgsql    php8.1-yaml php8.1-dev    php8.1-imagick   php8.1-memcached php8.1-uuid   php8.1-zip php8.1-bz2   php8.1-zmq php8.1-interbase php8.1-mysql  php8.1-soap  php8.1-cli    php8.1-fpm    php8.1-intl   php8.1-oauth  php8.1-xml php8.1-mongodb
